...
interface SideBarProps {
  updateSideBarWidth: (isOpen: boolean) => void; // Assuming updateSideBarWidth takes a boolean
}

export default function SideBar({ updateSideBarWidth }: SideBarProps) {
  ...
  const menuItems = [
    {
      title: "Home",
      icon: <Home style={{ fill: theme.palette.text.secondary }} />,
      page: "dashboard",
    },
    {
      title: "Account",
      icon: <Person style={{ fill: theme.palette.text.secondary }} />,
      page: "account",
    },
    {
      title: "Learning Paths",
      icon: <School style={{ fill: theme.palette.text.secondary }} />,
      page: "learning-path",
    },
    {
      title: "Friends",
